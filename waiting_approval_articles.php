...
$query = "SELECT * FROM blog_articles WHERE status = 'pending' AND posted_by_id = '$posted_by_id' ORDER BY id DESC";
    ...
    <section id="profile">
        <div class="container-custom">
            <div class="container-inner">
                <h2 class="text-center font-weight-bold mt-3 mb-3">Waiting Approval</h2>
                <div class="row justify-content-center">
                    <div class="col-md-10 col-sm-12 col-xs-12">
                        ...
                        <div class="alert alert-warning text-center">No pending articles found!</div>
                        <?php } else { ?>
                            <?php
