...
<body>
    ...
    <section id="contact" class="">
        <div class="every-top-bg">
            <h2 class="every-top-heading">Contact</h2>
        </div>
                    ...
                    <div class="col-md-6 mt-5">
                        <ul class="list-group">
                            ...
                            <li class="list-group-item">
                                <i class="fa fa-map-marker pr-2" aria-hidden="true"></i><a href="https://goo.gl/maps/iCjRXgqTpePRjB1D9" target="_blank" class="text-black">Govt. Islamia College, Civil Lines Lahore, Pakistan</a></li>
                            <li class="list-group-item">
