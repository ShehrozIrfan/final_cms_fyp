...
<head>
    ...
    <title>Examination Management | GICCL</title>
    <!-- bootstrap -->
    ...
    <div id="about-us-page">
        <div class="about-top-bg" id="about-top">
            <div class="every-top-bg">
                <h2 class="every-top-heading">Examination Management</h2>
            </div>
            <div class="container parent-management">
                <div class="row">
                    <div class="col-md-12">
                      <div>
                        <h4 class="management-heading">This is the sample page for examination management. The examination management module will be added later which is already built by our seniors. As per the supervisor's instruction we've added this link here, so that they can add the examination management module link here.</h4>
                      </div>
                    </div>
                </div>
            </div>
