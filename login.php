   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      if($count == 1) {
        if($row['is_approved'] == 'false') {
            $msg = "Sorry! Your account is not approved. You can login, once your account get approved from admin.";
            $msgClass = "warning";
        } else if($row['is_approved'] == 'declined') {
            $msg = "Your account has been declined by admin. You cannot login!";
            $msgClass = "danger";
        } else {
                ...
                <div class="container">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-11 col-sm-12 col-xs-12">
                            ...
                            <p class="text-center pt-3">Don't have an account? <a href="signup.php" class="login-signup-btn">Signup</a></p>
                        </div>
                    </div>
                </div>
