...
$query = "SELECT * FROM blog_articles WHERE status = 'declined' AND posted_by_id = '$posted_by_id' ORDER BY id DESC";
...
if(isset($_GET['delete'])) {
    ...
    if(!$result_d) {
        ...
        $msgClass = "success";
        header("Refresh:1; url=not_accepted_articles.php");
    }
}
?>
<!DOCTYPE html>
    ...
    <section id="profile">
        <div class="container-custom">
            <div class="container-inner">
                <h2 class="text-center font-weight-bold mt-3 mb-3">Declined Articles</h2>
                ...
                <div class="col-md-10 col-sm-12 col-xs-12">
                        ...
                        <div class="alert alert-warning text-center">No declined articles found!</div>
                        <?php } else { ?>
                            <?php
                                while ($row = mysqli_fetch_array($result)) { ?>
                                    ...
                                    <tr>
                                        <td><a onClick="javascript: return confirm('Please confirm article deletion!');" href="not_accepted_articles.php?delete=<?php echo $row['id']; ?>" class="btn btn-danger btn-block"><i class="fa fa-trash-o mr-2"></i>Delete</a></td>
                                    </tr>
                                </table>
                                <?php } ?>
                        <?php } ?>
