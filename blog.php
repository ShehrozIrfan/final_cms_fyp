                ...
                <div class="row">
                    <div class="col-md-10 col-sm-12 col-xs-12">
                        <div class="blog-headline">
                            <div><h3>GIGCCL - Blog</h3></div>
                            <div class="blog-write-login">
                                <div><a href="signup_blog.php" class="btn-login"><span>Write</span></a></div>
                                <div class="mt-2 pl-2"><a href="login_blog.php" class="login-signup-btn"><span>Login</span></a></div>
                            </div>
                        </div>
                    </div>
