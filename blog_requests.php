                ...
                <div class="row justify-content-center">
                    <div class="col-md-10 col-sm-12 col-xs-12">
                        ...
                        <?php if(mysqli_num_rows($result_pen) == 0){ ?>
                            <div class="alert alert-warning text-center ">No pending blog requests found!</div>
                        <?php } else { ?>
                            <?php
                        ...
                        <?php if(mysqli_num_rows($result_ap) == 0){ ?>
                            <div class="alert alert-warning">No approved blog requests found!</div>
                        <?php } else { ?>
                            <?php
                        ...
                        <?php if(mysqli_num_rows($result_dc) == 0){ ?>
                            <div class="alert alert-warning">No declined blog requests found!</div>
                        <?php } else { ?>
                            <?php
